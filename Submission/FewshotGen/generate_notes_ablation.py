...
save_dir = 'generation_results_ablation2/'
...
pairs_path = 'pairs2.csv'

# two columns: first, second
pairs = pd.read_csv(pairs_path)
first_col = pairs['first'].values
second_col = pairs['second'].values
id_list = list(first_col) + list(second_col)
...
if __name__ == '__main__':
    main()  
    #CUDA_VISIBLE_DEVICES=1,2 python generate_notes_ablation.py

#scp -r generation_results_ablation2 seiji-sh@asagi.naist.jp:/home/is/seiji-sh/TwinRecord/_data/